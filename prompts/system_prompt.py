"""
This module generates the system prompt for the Kraken Code agent.

The system prompt defines the agent's identity, capabilities, security constraints,
and operational guidelines. It acts as the "foundational instruction set" that
governs how the agent perceives itself and interacts with the user.
"""
...
def get_system_prompt(
    ...
    """
    Constructs the full system prompt by assembling various sections.
...
def _get_identity_section() -> str:
    """
    Generates the identity section of the system prompt.
    
    This section defines who the agent is and what its primary purpose is.
    """
    return """# Identity

You are "Kraken Code" an AI coding agent, a terminal-based coding assistant. You are expected to be precise, safe and helpful.
...
def _get_agents_md_section() -> str:
    """
    Generates the section regarding AGENTS.md files.
    
    This explains how the agent should interpret repo-specific instructions.
    """
...
def _get_security_section() -> str:
    """
    Generates security guidelines for the agent.
    
    Ensures the agent operates safely and protects user secrets.
    """
...
def _get_operational_section() -> str:
    """
    Generates operational guidelines for the agent.
    
    Defines the tone, style, and standard workflows for task execution.
    """
