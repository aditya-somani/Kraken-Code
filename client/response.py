...
class StreamEventType(StrEnum):
    ...
    TOOL_CALL_START = "tool_call_start" # A tool call was made
    TOOL_CALL_DELTA = "tool_call_delta" # A chunk of a tool call was made
    TOOL_CALL_COMPLETE = "tool_call_complete" # A tool call was completed
...
class ToolCallDelta:
    """
    Represents a small increment of a tool call generated by the LLM.

    Used primarily during streaming to capture each piece of the tool call
    as it arrives.

    Attributes:
        call_id: The unique identifier for the tool call.
        name: The name of the tool to be called.
        arguments_delta: The arguments for the tool call.
    """
    call_id: str
    name: str | None = None
    arguments_delta: str = ""
...
class ToolCall:
    """
    Represents a complete tool call generated by the LLM.
...
class StreamEvent:
    ...
    Attributes:
        ...
        tool_call_delta: The tool call delta (if applicable).
        tool_call: The tool call (if applicable).
    """
    ...
    @classmethod
    def stream_tool_call_delta(
        cls,
        call_id: str,
        name: str,
        arguments_delta: str,
    ) -> StreamEvent:
        """Creates an event signaling a delta in the tool call arguments."""
        return cls(
...
class ToolResultMessage:
    ...
    # But we need to convert this message into OpenAI compatible format for the agent to understand
    def to_openai_message(self) -> dict[str, Any]:
        """Converts the tool result message to an OpenAI compatible format."""
        return {
            "role": "tool",
...
def parse_tool_call_arguments(arguments_str: str) -> dict:
    """
    Parses the arguments of a tool call.

    Args:
        arguments_str: The arguments of the tool call as a string.
